          ...
          <div className="bg-card/30 border border-border rounded-xl p-12 shadow-soft hover-elegant">
            ...
            <div className="space-y-6">
              <p className="text-lg font-body text-foreground leading-relaxed">
                The pleasure of your company is the greatest gift we could ever receive. For those who have kindly asked about giving a contribution, we are humbly building the foundation of our future together. Your monetary gift would truly help support our long-term plans as we begin this new chapter, and we are deeply grateful for your generosity.
              </p>
              <p className="text-sm font-semibold text-primary mt-4">
                RSVP Deadline: December 2, 2025
              </p>
            </div>
