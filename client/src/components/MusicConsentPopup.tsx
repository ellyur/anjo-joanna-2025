          ...
          >
            ...
            <div className="relative text-center space-y-6">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <Heart className="w-4 h-4 icon-burgundy-fill" />
              ...
              >
                <div className="bg-primary p-5 rounded-full shadow-lg">
                  <Music className="h-10 w-10 text-primary-foreground icon-burgundy" />
                </div>
              </motion.div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8">
                ...
                >
                  <Volume2 className="h-5 w-5 mr-2 icon-burgundy" />
                  Play Music
                </Button>
                <Button
                ...
                >
                  <VolumeX className="h-5 w-5 mr-2 icon-burgundy" />
                  Continue Silently
                </Button>
              </div>

              <div className="flex items-center justify-center gap-2 pt-4">
                <Heart className="w-3 h-3 icon-burgundy-fill opacity-50" />
