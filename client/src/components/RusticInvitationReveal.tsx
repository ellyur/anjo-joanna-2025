...
// Polaroid images
const groomImage = 'https://res.cloudinary.com/dphjoqgvb/image/upload/v1764341214/solo_groom_ch3l77.jpg';
const coupleImage = 'https://res.cloudinary.com/dphjoqgvb/image/upload/v1764341209/couple_vvbpa3.jpg';
const brideImage = 'https://res.cloudinary.com/dphjoqgvb/image/upload/v1764341214/solo_bride_yt4jol.jpg';
