  ...
  const faqs = [
    {
      ...
      icon: MessageCircle,
      answer: "You can RSVP right here on our wedding website by clicking the RSVP button. We kindly ask that all guests RSVP by December 2, 2025 so we can plan everything perfectly!"
    },
    {
    ...
    },
    {
      ...
      icon: Camera,
      answer: "Yes, please do! Snap away during cocktail hour and the reception, and share your favorite memories using our official hashtags: #TheweddingofAnjoAndJoanna and #AnjoAndJoanna2025"
    }
  ];
