        ...
        >
            ...
            >
                <div className="bg-white backdrop-blur-sm border border-primary/30 rounded-2xl p-8 shadow-teal">
                    ...
                    <h3 className="text-2xl md:text-3xl font-script italic mb-4 text-foreground" data-testid="text-unplugged-title">
                        An Unplugged Ceremony
                    </h3>
                    <p className="text-sm md:text-base text-muted-foreground mb-4">
                        We invite you to be fully present with us during our ceremony. We have hired an amazing team of professionals to capture every moment, and we promise to share the photos with you as soon as possible!
                    </p>
                    <p className="text-sm md:text-base text-muted-foreground">
                        We kindly ask that you turn off your phones and cameras and enjoy this special moment with your hearts, not your screens. Once the reception begins, feel free to snap away!
                    </p>
                </div>
            </motion.div>
            {/* Oh Snap! Section */}
            ...
            >
                <div className="bg-white backdrop-blur-sm border border-primary/30 rounded-2xl p-8 shadow-teal">
                    ...
                    <div className="inline-block border-2 border-primary rounded-lg px-4 md:px-6 py-3 bg-[#ffffff] max-w-full">
                        <p className="text-primary text-sm sm:text-base md:text-lg break-all" style={{ fontFamily: 'Satoshi, sans-serif' }} data-testid="text-hashtag">#JOANNAndOnlyForANJO
</p>
                    </div>
                </div>
            </motion.div>
